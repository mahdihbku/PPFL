# -*- coding: utf-8 -*-
"""
Created on Sun Apr  4 21:29:49 2021
...
# creating the socket for communication 
listening_sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
listening_sock.setsockopt(socket.SOL_SOCKET, socket.SO_REUSEADDR, 1)
# listening_sock.bind(("192.168.10.32", 10000))
...
partcicpants=[]
#select the nmuber of participantce 
num_selected = 1 # as we have 1 sensor 
# force the process to be on the cpu
...
# reciving messages from clinets 
