...
soc.connect(("192.168.43.47", 10000))
...
#while True:
count_r=count_r+1
clients_model.load_state_dict(global_model.state_dict())
...
"""Local Models aggregations and Global model Fusion"""
    # server_aggregate(global_model, clients_model)   
# print(f'##########{r+1}-th round')
"""Evalute The global model every global round"""
#acc, loss = test_(clients_model, criterion, test_loader)
