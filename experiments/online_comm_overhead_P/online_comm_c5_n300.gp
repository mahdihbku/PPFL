...
set output "online_comm_c5_n300.png"
set datafile sep ','
...
plot [9999:138357545][:130001] '../online_comm/online_comm.csv' every ::144::152 using 3:($4-$7) title 'Client' with linespoints pt 2 ps 2 lc 7, \
             '../online_comm/online_comm.csv' every ::144::152 using 3:($5-$8) title 'Server' with linespoints pt 4 ps 2 lc 2, \
             '../online_comm/online_comm.csv' every ::144::152 using 3:6 title 'Committee member' with linespoints pt 6 ps 2 lc 3
