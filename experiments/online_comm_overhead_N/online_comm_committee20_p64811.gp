...
plot [0:][0.5:201] '../online_comm/online_comm.csv' every 45::38 using 1:($4-$7) title 'Client' with linespoints lc 7 pt 2 ps 2, \
             '../online_comm/online_comm.csv' every 45::38 using 1:($5-$8) title 'Server' with linespoints pt 4 ps 2 lc 2, \
             '../online_comm/online_comm.csv' every 45::38 using 1:6 title 'Committee member' with linespoints pt 6 ps 2 lc 3
