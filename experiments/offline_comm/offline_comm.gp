...
set log y
plot [0:][0.5:13000] 'offline_comm.csv' using 1:2 title 'Client' with linespoints pt 2 ps 2 lc 1, 'offline_comm.csv' using 1:3 title 'Server' with linespoints pt 4 ps 2 lc 2
